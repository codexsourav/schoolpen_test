...
class FreeClass extends StatefulWidget {
  const FreeClass({super.key, required this.height, required this.width});
  final double height;
  final double width;

  @override
  State<FreeClass> createState() => _OnGoingClassState();
}

class _OnGoingClassState extends State<FreeClass> {
  @override
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return const ClassesCard(
                              backGroundColor: Color(0xFFFFD16E),
                              className: 'Class2-A',
                              subjectName: 'Science',
