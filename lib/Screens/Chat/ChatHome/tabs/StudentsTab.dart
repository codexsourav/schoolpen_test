...
class LoadStudentTab extends StatefulWidget {
  dynamic chatuserId;
  ...
  @override
  State<LoadStudentTab> createState() => _LoadStudentTabState();
}

class _LoadStudentTabState extends State<LoadStudentTab> {
  late String image;
  late String userid;
  late String name;
  late String roal;
